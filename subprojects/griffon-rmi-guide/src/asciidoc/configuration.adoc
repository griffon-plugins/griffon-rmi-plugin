...
----
dependencies {
    griffon '{project-group}:griffon-rmi-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-rmi-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-rmi-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-rmi-plugin` BOM in your POM file, by placing the following
